...
Usage::
    ...
    python3 analyze_str.py [--mcpu <cpu>] [--window-width <W>] [--dependency <mode>]
                           [--mlp-window-assignment <mode>] <textfile>
"""
...
def main():
    parser = argparse.ArgumentParser(
        ...
        usage=(
            "%(prog)s [--mcpu CPU] [--window-width W] "
            "[--dependency {none,io,ooo}] "
            "[--mlp-window-assignment {forward,max-containing}] <textfile>"
        )
    )
    parser.add_argument(
        "textfile",
